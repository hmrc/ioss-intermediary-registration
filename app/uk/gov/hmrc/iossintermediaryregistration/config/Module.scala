...
import uk.gov.hmrc.iossintermediaryregistration.controllers.actions.{AuthAction, AuthActionImpl, AuthenticatedControllerComponents, DefaultAuthenticatedControllerComponents}
