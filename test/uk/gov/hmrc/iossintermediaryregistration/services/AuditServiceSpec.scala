...
import uk.gov.hmrc.iossintermediaryregistration.models.audit.JsonAuditModel
...
class AuditServiceSpec extends AnyFreeSpec with MockitoSugar with ScalaFutures with Matchers with BeforeAndAfterEach {
  ...
  case class TestAuditModel(customItem: String) extends JsonAuditModel {
    override val auditType: String = "Test"
    override val transactionName: String = "test"
